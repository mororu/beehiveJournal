<script lang="ts">
	...
	// A concrete year always carries 12 buckets, so length is not emptiness (AC35)
	const hasData = $derived(buckets.some((b) => b.count > 0));
...
<div class="chart-wrap">
	...
	{:else}
		<canvas bind:this={canvas} aria-label="Stiche pro Monat"></canvas>
	{/if}
</div>
