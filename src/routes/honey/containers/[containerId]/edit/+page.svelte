<script lang="ts">
	...
	let name = $state(form?.name ?? data.container.name);
	let sizeG = $state(form?.sizeGRaw ?? String(data.container.sizeG));
	let isSubmitting = $state(false);
</script>

<svelte:head>
	<title>Behältergröße bearbeiten — beehiveJournal</title>
</svelte:head>

<div class="form-page">
	<div class="form-page__header">
		<a href="/honey/containers" class="back-link">← Behältergrößen</a>
		<h1>Behältergröße bearbeiten</h1>
	</div>
